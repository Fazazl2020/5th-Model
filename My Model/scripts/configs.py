...
train_conf = {
    ...
    # ==================== PESQ EVALUATION (ADDED) ====================
    'pesq_eval_frequency': 5,   # Evaluate PESQ every N epochs
    ...
    'pesq_log': 'pesq.csv',     # CSV file to log PESQ scores
}
...
def print_config_summary():
    ...
    # Test settings (ADDED)
    print("\nTest Settings:")
    print(f"  Model file: {test_conf['model_file']}")
    print(f"  Batch size: {test_conf['batch_size']}")
